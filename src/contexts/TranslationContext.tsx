...
const translations = {
  ...
  hi: {
    ...
    heroSubtitle:
      "भारतीय पांडुलिपि विद्यालय प्राचीन भारतीय लिपियों और उनके सांस्कृतिक महत्व के बारे में उत्साही लोगों को शिक्षित करने के लिए समर्पित है।",
    ...
    // Footer
    schoolName: "भारतीय पांडुलिपि विद्यालय",
    footerDescription:
    ...
    allRightsReserved: "© 2025 भारतीय पांडुलिपि विद्यालय। सर्वाधिकार सुरक्षित।",
    preservingWisdom:
